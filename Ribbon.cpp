...
MainWindow::MainWindow(QWidget *par) :SARibbonMainWindow(par)
{
	...
	int lastTimes = 0;
	cost.start();
	setWindowTitle(QStringLiteral("this is test for window title"));
	...
	//ribbon->applitionButton()->setIcon(QIcon(":/icon/icon/chartDataManager.png"));
	//createMenuFile
	QMenu* menu = new QMenu(this);
	QPushButton *pB = dynamic_cast<QPushButton*>(ribbon->applitionButton());
	pB->setMenu(menu);
	QWidgetAction* actionNew = new QWidgetAction(this);
	actionNew->setDefaultWidget(new MenuItemWidget(QPixmap(":/icon/icon/save.png"), QString::fromStdWString(L"新建"), this));
	menu->addAction(actionNew);
	QWidgetAction* actionOpen = new QWidgetAction(this);
	actionOpen->setDefaultWidget(new MenuItemWidget(QPixmap(":/icon/icon/save.png"), QString::fromStdWString(L"打开"), this));
	menu->addAction(actionOpen);
	QWidgetAction* actionSave = new QWidgetAction(this);
	actionSave->setDefaultWidget(new MenuItemWidget(QPixmap(":/icon/icon/save.png"), QString::fromStdWString(L"保存"), this));
	menu->addAction(actionSave);

	QWidgetAction* actionSaveAs = new QWidgetAction(this);
	actionSaveAs->setDefaultWidget(new MenuItemWidget(QPixmap(":/icon/icon/save.png"), QString::fromStdWString(L"另存为"), this));
	menu->addAction(actionSaveAs);

	menu->addSeparator();

	QWidgetAction* actioPrint = new QWidgetAction(this);
	actioPrint->setDefaultWidget(new MenuItemWidget(QPixmap(":/icon/icon/save.png"), QString::fromStdWString(L"打印"), this));
	menu->addAction(actioPrint);

	menu->addSeparator();

	QWidgetAction* actionAout = new QWidgetAction(this);
	actionAout->setDefaultWidget(new MenuItemWidget(QPixmap(":/icon/icon/save.png"), QString::fromStdWString(L"关于"), this));
	menu->addAction(actionAout);

	QWidgetAction* actionExit = new QWidgetAction(this);
	actionExit->setDefaultWidget(new MenuItemWidget(QPixmap(":/icon/icon/save.png"), QString::fromStdWString(L"退出"), this));
	...
	SARibbonCategory* contextCategoryPage1 = m_contextCategory->addCategoryPage(QStringLiteral("context 1"));
	createCategoryContext1(contextCategoryPage1);
	
	SARibbonCategory* contextCategoryPage2 = m_contextCategory->addCategoryPage(QStringLiteral("context 2"));
...
void MainWindow::createCategoryMain(SARibbonCategory *page)
{
	...
	menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("222222"));
	menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("2"));
	menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("22"));
	menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("222"));
	menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("222222"));
	menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("222222222"));
...
void MainWindow::createCategoryContext1(SARibbonCategory * page)
{
	SARibbonMenu* menu = new SARibbonMenu(this);
	QAction * item = menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("1111111"));
	menu->addAction(QIcon(":/icon/icon/folder.png"), QStringLiteral("1111111"));
